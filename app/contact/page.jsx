...
function Contact() {
  ...
  <div className=' w-full sm:w-1/4 flex lg:flex-col md:flex-col sm:flex-row flex-col justify-center items-center mb-4 sm:mb-0'>
    ...
    <div className=' text-sm text-center mt-2'>Address: B-31 Rajdhani Park, Nangloi Delhi-41</div>
  </div>
  <div className=' w-full sm:w-1/4 flex lg:flex-col md:flex-col sm:flex-row flex-col justify-center items-center mb-4 sm:mb-0'>
    <div className=' h-12 w-full flex justify-center items-center mb-2'>
      <img src="/contact/call.png" height={50} width={50} alt="" />
    </div>
    <div className=' text-sm text-center mt-2'>Phone: 8882108780</div>
  </div>
  <div className=' w-full sm:w-1/4 flex lg:flex-col md:flex-col sm:flex-row flex-col justify-center items-center mb-4 sm:mb-0'>
    <div className=' h-12 w-full flex justify-center items-center mb-2'>
      <img src="/contact/email.png" height={50} width={50} alt="" />
    </div>
    <div className=' text-sm text-center mt-2'>Email: srivastavajaya175@gmail.com</div>
  </div>
  <div className=' w-full sm:w-1/4 flex lg:flex-col md:flex-col sm:flex-row flex-col justify-center items-center mb-4 sm:mb-0'>
    <div className=' h-12 w-full flex justify-center items-center mb-2'>
      <img src="/contact/website.png" height={50} width={50} alt="" />
    </div>
    <div className=' text-sm text-center mt-2'>Website: Housify.com</div>
  </div>
</div>
